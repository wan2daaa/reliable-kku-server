...
include::{snippets}/order/duplicate/success/response-fields.adoc[]

=== 주문이 만약 현재 진행중이아니면 400을 던진다

==== Request

include::{snippets}/order/duplicate/fail/http-request.adoc[]

==== Response

include::{snippets}/order/duplicate/fail/http-response.adoc[]
include::{snippets}/order/duplicate/fail/response-fields.adoc[]
...
=== 현재 주문시 대략적으로 걸리는 시간을 리턴한다 (주문시간 + 10분)

==== Request

include::{snippets}/order/left-time/success/http-request.adoc[]

==== Response

include::{snippets}/order/left-time/success/http-response.adoc[]
include::{snippets}/order/left-time/success/response-fields.adoc[]